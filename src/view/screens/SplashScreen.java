...
public class SplashScreen extends JFrame {
  ...
  private String text = "<html> Welcome to the <br> Marvel Food Court! </html>";
  private String c = "<html>Credits: <br><br>   {Developers} <br> Gowtham Potnuru <br> Aashi Shrimal </html>";
